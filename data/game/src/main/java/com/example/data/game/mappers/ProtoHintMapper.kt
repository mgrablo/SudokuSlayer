...
fun Hint.toProtoHint(): ProtoHint =
	protoHint {
...
fun ProtoHintType.toHintType(): HintType =
	when (this.type) {
		...
		ProtoHintType.Type.HintType_UNSPECIFIED -> throw IllegalArgumentException("Hint type is unspecified")
...
fun HintType.toProtoHintType(): ProtoHintType =
	protoHintType {
		type =
...
fun GroupType.toProtoHintHouse() =
	protoHintHouse {
...
fun ProtoHintHouse.toGroupType(): GroupType =
	when (this.houseType) {
		...
		ProtoHintHouse.Type.HouseType_UNSPECIFIED -> throw IllegalArgumentException("House type is unspecified")
